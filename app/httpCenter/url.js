module.exports = {
  ...
  DetectEntity: { //左侧按钮点击需要的访问的url
    method: "GET",
    url: "http://localhost:8080/app/modulexpl.json"
  },
  GetTag: {  //右侧按钮点击需要的访问的url
    method: "GET",
    url: "http://localhost:8080/app/menudata.json"
  },
  /*DetectEntity: {
    method: "POST",
